package net.revtut.libraries.minecraft.bukkit.guns.events;

import net.revtut.libraries.minecraft.bukkit.guns.Gun;
import net.revtut.libraries.minecraft.bukkit.guns.ShotType;
