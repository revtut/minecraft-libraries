package net.revtut.libraries.minecraft.bukkit.appearance;
...
public final class Effects {
    ...
    public static void circleParticleEffect(final Location center, final double slope, final double radius, final int numberPoints, final EnumParticle enumParticle) {
        final List<Location> circleLocations = Maths.getCircle(center, 0, slope, radius, numberPoints, net.revtut.libraries.minecraft.bukkit.maths.Rotation.CLOCKWISE);
    ...
    public static void helixParticleEffect(final Location center, final double height, final double radius, final int numberPoints, final int numberCircles, final EnumParticle enumParticle) {
        final List<Location> helixLocations = Maths.getHelix(center, height, 0, radius, numberPoints, numberCircles, net.revtut.libraries.minecraft.bukkit.maths.Rotation.CLOCKWISE);
